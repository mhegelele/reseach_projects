...
<div class="incu">
 ...
 <div class="col-md-4">
  <table class="table striped">
    <tr>
      <td colspan="2"><input type="hidden" name="id" value=" {{$pubs->pro_id}}">
             <input type="submit" class="btn  btn-primary btn-block "  value="Update" {{session()->has('success')? 'disabled':''}}/>
                 </form>
           </td>
             <td colspan="2">
             ...
             <td colspan="2">
             	...
             	<form method="POST" action="{{url('approve-project')}}">
                  {{csrf_field()}}
              <input type="hidden" name="id" value=" {{$pubs->pro_id}}">
               <input type="submit" class="btn  btn-warning btn-block"  value="Approve" {{session()->has('success')? 'disabled':''}}/>
               </form>
             </td>
    </tr>
  </table>
