...
<h2 style="text-transform: uppercase;"> <span>Update Publication</span></h2>
...
<tr> <td colspan="2">
 <textarea rows="5" cols="20" class="form-control" name="publication">{{$pubs->publication}}</textarea>
  </td></tr>
...
<!-- <button type="submit" class="btn btn-primary">
  <i class="fa fa-minus icon-white"></i></button> -->
</form>
    </table>
