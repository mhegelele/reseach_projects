...
<h2 style="text-transform: uppercase;"> <span>Update Sponsor </span></h2>
...
<tr> <td colspan="2">
 <textarea rows="5" cols="20" class="form-control" name="sponsor">{{$pubs->sponsor}}</textarea>
  </td></tr>
      <tr> <td><input type="hidden" name="id" value=" {{$pubs->s_id}}">
