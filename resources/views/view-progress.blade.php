...
<h2 style="text-transform: uppercase;"> <span>Update Quartely Progress </span></h2>
...
<tr> <td colspan="2">
 <textarea rows="5" cols="20" class="form-control" name="name_progress">{{$pubs->name_progress}}</textarea>
  </td></tr>
      <tr> <td><input type="hidden" name="id" value=" {{$pubs->q_id}}">
