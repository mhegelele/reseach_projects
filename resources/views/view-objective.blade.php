...
<h2 style="text-transform: uppercase;"> <span>Update specific Objective </span></h2>
...
<table class="table">
    ...
    <form method="POST" action="{{url('objectives')}}">
    {{csrf_field()}}
   
<tr> <td colspan="2">
 <textarea rows="5" cols="20" class="form-control" name="name_objective">{{$pubs->name_objective}}</textarea>
  </td></tr>
      <tr> <td><input type="hidden" name="id" value=" {{$pubs->o_id}}">
