...
<li class="{{ Request::segment(1) === 'home' && '/' ? 'active' : null }} " >
                     <a href="{{ url('home')}}"><span class="fa fa-home desktop-home"></span><span class="mobile-show">Home</span></a>
                    </li>
...
document.getElementById("demo").innerHTML = days[d.getDay()] + "," +" " + months[d.getMonth()] + " " +d.getDate() + " " + ","  + d.getFullYear();
 ...
 $("#appendu").click( function(e) {
          e.preventDefault();
        $(".incu").append('<div>\
          <textarea rows="5" cols="20" class="form-control" name="name_progress[]"></textarea>\
                                          <a href="#" class="remove_this fa fa-minus primary" style="color:red"></a>\
                <br>\
                        </div>');
        return false;
